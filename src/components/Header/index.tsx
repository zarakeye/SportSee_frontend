...
const Header: React.FC = () => {
  return (
    <>
      {/* <header id="apHeader" className="absolute bg-black flex flex-row w-full justify-between bg-secondary h-[91px] pl-[28px] pt-[18px] pb-[12px] pr-[91px] shadow-[0px_4px_4px_0px_rgba(0,_0,_0,_0.2)]"> */}
